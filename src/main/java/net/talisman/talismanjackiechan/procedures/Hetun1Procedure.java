	...
	public static void execute(Entity entity, ItemStack itemstack) {
			...
			return;
		{
			...
			if (!projectileLevel.isClientSide()) {
				Projectile _entityToSpawn = initArrowProjectile(createArrowWeaponItemStack(new PufferPowerEntity(TalismanJackiechanModEntities.PUFFER_POWER.get(), 0, 0, 0, projectileLevel), 1, (byte) 0), entity, 1, true, false, false,
