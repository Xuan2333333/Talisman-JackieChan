...
public class Modellplp<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("talisman_jackiechan", "modellplp"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition all2 = partdefinition.addOrReplaceChild("all2",
				CubeListBuilder.create().texOffs(17, 0).addBox(1.25F, -9.0F, -3.0F, 3.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(64, 81).addBox(-1.0F, -5.0F, -5.0F, 2.0F, 9.0F, 0.8F, new CubeDeformation(0.0F)).texOffs(16, 9)
		...
		PartDefinition leftarm = all2.addOrReplaceChild("leftarm", CubeListBuilder.create(), PartPose.offset(0.0F, 1.0F, 0.0F));
		...
		PartDefinition cube_r9 = leftarm.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(32, 0).mirror().addBox(-2.75F, -2.0F, -2.75F, 3.5F, 4.0F, 4.75F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition cube_r17 = group52.addOrReplaceChild("cube_r17", CubeListBuilder.create().texOffs(102, 12).addBox(-0.5F, -0.725F, -1.5F, 1.0F, 1.0F, 2.4F, new CubeDeformation(0.0F)),
		...
		PartDefinition group50 = all2.addOrReplaceChild("group50", CubeListBuilder.create().texOffs(56, 115).addBox(7.5F, -7.0F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(56, 99)
				.addBox(8.0F, -7.0F, -1.5F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(48, 34).addBox(7.0F, -7.0F, -0.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition group48 = fgv.addOrReplaceChild("group48", CubeListBuilder.create().texOffs(74, 64).addBox(-13.25F, -2.5F, 10.55F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(26, 68)
		...
		PartDefinition group44 = efr.addOrReplaceChild("group44", CubeListBuilder.create().texOffs(66, 97).addBox(-1.5F, -13.0F, 4.05F, 3.0F, 1.0F, 1.75F, new CubeDeformation(0.0F)).texOffs(22, 116)
				.addBox(-0.5F, -14.0F, 4.05F, 1.0F, 3.0F, 1.75F, new CubeDeformation(0.0F)).texOffs(112, 111).addBox(-1.0F, -13.5F, 4.05F, 2.0F, 2.0F, 1.75F, new CubeDeformation(0.0F)), PartPose.offset(8.0F, 8.0F, -8.0F));
		...
		PartDefinition group38 = all2.addOrReplaceChild("group38",
				CubeListBuilder.create().texOffs(34, 47).addBox(-0.35F, 0.05F, -1.1F, 0.9F, 1.0F, 0.45F, new CubeDeformation(0.0F)).texOffs(0, 0).addBox(-0.1F, 0.85F, -1.1F, 0.9F, 0.0F, 0.45F, new CubeDeformation(0.0F)).texOffs(30, 47)
						.addBox(0.15F, -0.05F, -1.1F, 0.9F, 1.0F, 0.45F, new CubeDeformation(0.0F)).texOffs(30, 39).addBox(-0.1F, 0.0F, -1.1F, 0.9F, 1.0F, 0.45F, new CubeDeformation(0.0F)).texOffs(30, 42)
						.addBox(0.15F, -0.1F, -1.1F, 0.9F, 1.0F, 0.45F, new CubeDeformation(0.0F)).texOffs(0, 0).addBox(-0.45F, 1.2F, -1.1F, 0.9F, 0.0F, 0.45F, new CubeDeformation(0.0F)).texOffs(30, 43)
						.addBox(-0.6F, 0.4F, -1.1F, 0.9F, 1.0F, 0.45F, new CubeDeformation(0.0F)).texOffs(32, 47).addBox(0.4F, -0.15F, -1.1F, 0.9F, 1.0F, 0.45F, new CubeDeformation(0.0F)),
				PartPose.offset(1.25F, -11.75F, -2.25F));
		PartDefinition group37 = all2.addOrReplaceChild("group37",
				CubeListBuilder.create().texOffs(0, 75).addBox(7.0F, -15.0F, 4.3F, 2.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(52, 78).addBox(8.0F, -16.0F, 4.3F, 1.0F, 9.0F, 1.5F, new CubeDeformation(0.0F)),
				PartPose.offset(-6.0F, 6.0F, -8.0F));
		PartDefinition group36 = all2.addOrReplaceChild("group36", CubeListBuilder.create().texOffs(18, 18).addBox(8.75F, -15.0F, 2.0F, 1.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-6.0F, 5.0F, -5.0F));
		...
		PartDefinition group34 = all2.addOrReplaceChild("group34",
				CubeListBuilder.create().texOffs(8, 75).addBox(-9.1F, -15.0F, 4.3F, 2.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(58, 81).addBox(-9.0F, -16.0F, 4.3F, 1.0F, 9.0F, 1.5F, new CubeDeformation(0.0F)),
				PartPose.offset(6.0F, 6.0F, -8.0F));
		...
		PartDefinition n = cb.addOrReplaceChild("n",
				CubeListBuilder.create().texOffs(98, 33).addBox(-5.0F, 13.25F, 1.0F, 2.0F, 2.0F, 2.3F, new CubeDeformation(0.0F)).texOffs(98, 58).addBox(-3.0F, 13.25F, 1.0F, 2.0F, 2.0F, 2.3F, new CubeDeformation(0.0F)).texOffs(31, 29)
						.addBox(-2.0F, 13.25F, -3.0F, 4.0F, 2.0F, 6.3F, new CubeDeformation(0.0F)).texOffs(88, 98).addBox(1.0F, 13.25F, 1.0F, 2.0F, 2.0F, 2.3F, new CubeDeformation(0.0F)).texOffs(96, 98)
						.addBox(3.0F, 13.25F, 1.0F, 2.0F, 2.0F, 2.3F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition qwfr = cb.addOrReplaceChild("qwfr",
				CubeListBuilder.create().texOffs(18, 49).addBox(-5.0F, 13.25F, -3.4F, 2.0F, 2.0F, 2.4F, new CubeDeformation(0.0F)).texOffs(66, 49).addBox(-3.0F, 13.25F, -3.4F, 2.0F, 2.0F, 2.4F, new CubeDeformation(0.0F)).texOffs(78, 31)
		...
		PartDefinition qw = wqr2.addOrReplaceChild("qw",
				CubeListBuilder.create().texOffs(50, 8).addBox(3.0F, -6.0F, 1.0F, 7.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(56, 111).addBox(1.0F, -6.0F, 1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(72, 111)
						...
						.addBox(-1.0F, -9.0F, 3.5F, 2.0F, 10.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(54, 67).addBox(0.0F, -13.0F, 3.25F, 2.0F, 9.0F, 1.25F, new CubeDeformation(0.0F)).texOffs(20, 94)
						.addBox(1.0F, -9.0F, 2.0F, 2.0F, 3.0F, 2.5F, new CubeDeformation(0.0F)).texOffs(93, 81).addBox(1.0F, -11.0F, 1.5F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(34, 116)
						.addBox(2.0F, -13.0F, 3.05F, 2.0F, 3.0F, 0.95F, new CubeDeformation(0.0F)).texOffs(112, 24).addBox(1.0F, -11.0F, 0.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(10, 86)
						.addBox(1.0F, -11.0F, -3.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(36, 52).addBox(1.0F, -15.0F, -3.2F, 2.2F, 4.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(85, 22)
						.addBox(1.0F, -13.0F, 0.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(60, 74).addBox(-1.0F, -15.0F, -3.2F, 2.0F, 4.0F, 3.2F, new CubeDeformation(0.0F)).texOffs(86, 28)
						.addBox(-1.0F, -13.0F, 1.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(48, 52).addBox(-3.2F, -15.0F, -3.2F, 2.2F, 4.0F, 4.45F, new CubeDeformation(0.0F)).texOffs(82, 87)
						...
						.addBox(-6.0F, -15.25F, -0.35F, 2.0F, 4.0F, 3.85F, new CubeDeformation(0.0F)).texOffs(72, 72).addBox(-2.0F, -21.0F, 0.4F, 4.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(30, 89)
						...
						.addBox(-1.0F, -10.0F, 2.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(48, 112).addBox(1.0F, -10.0F, 2.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(112, 51)
						.addBox(1.0F, -10.0F, 2.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(112, 60).addBox(1.0F, -8.0F, 0.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(92, 5)
						.addBox(1.0F, -8.0F, -3.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(64, 112).addBox(1.0F, -10.0F, 0.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(66, 18)
						.addBox(4.0F, -15.25F, -0.6F, 2.0F, 4.0F, 4.1F, new CubeDeformation(0.0F)).texOffs(74, 49).addBox(-2.0F, -13.0F, 3.25F, 2.0F, 8.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(116, 98)
						.addBox(-4.0F, -13.0F, 3.05F, 2.0F, 3.0F, 0.95F, new CubeDeformation(0.0F)).texOffs(94, 38).mirror().addBox(2.0F, -11.0F, 2.0F, 1.0F, 3.0F, 2.5F, new CubeDeformation(0.0F)).mirror(false).texOffs(30, 94).mirror()
						.addBox(2.0F, -8.0F, 2.0F, 1.0F, 2.0F, 2.5F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition group28 = wqr2.addOrReplaceChild("group28", CubeListBuilder.create().texOffs(60, 59).addBox(0.0F, -2.0F, -1.5F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(16, 61)
				.addBox(1.0F, -2.75F, -1.5F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(62, 34).addBox(2.0F, -3.5F, -1.5F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(-8.0F, -4.5F, -1.0F));
		PartDefinition group27 = group28.addOrReplaceChild("group27", CubeListBuilder.create(), PartPose.offset(4.0F, 28.5F, -2.0F));
		PartDefinition rightarm = all2.addOrReplaceChild("rightarm", CubeListBuilder.create(), PartPose.offset(0.0F, 24.0F, 0.0F));
		...
		PartDefinition cube_r19 = rightarm.addOrReplaceChild("cube_r19", CubeListBuilder.create().texOffs(32, 0).addBox(-0.75F, -2.0F, -2.75F, 3.5F, 4.0F, 4.75F, new CubeDeformation(0.0F)),
		...
		PartDefinition leftleg = all2.addOrReplaceChild("leftleg",
				CubeListBuilder.create().texOffs(0, 32).addBox(1.5F, -11.0F, -2.0F, 3.0F, 7.0F, 3.5F, new CubeDeformation(0.0F)).texOffs(82, 82).addBox(1.75F, -4.0F, -1.5F, 2.5F, 2.0F, 2.75F, new CubeDeformation(0.0F)).texOffs(78, 18)
						.addBox(1.5F, -2.0F, -1.0F, 3.0F, 2.0F, 2.75F, new CubeDeformation(0.0F)).texOffs(40, 80).addBox(1.6F, -2.0F, -2.75F, 2.8F, 2.0F, 2.75F, new CubeDeformation(0.0F)).texOffs(40, 75)
		...
		PartDefinition rightleg = all2.addOrReplaceChild("rightleg",
				CubeListBuilder.create().texOffs(32, 18).addBox(-4.5F, -11.0F, -2.0F, 3.0F, 7.0F, 3.5F, new CubeDeformation(0.0F)).texOffs(80, 49).addBox(-4.4F, -2.0F, -2.75F, 2.8F, 2.0F, 2.75F, new CubeDeformation(0.0F)).texOffs(76, 34)
						.addBox(-4.15F, -1.0F, -4.5F, 2.3F, 1.0F, 3.75F, new CubeDeformation(0.0F)).texOffs(70, 83).addBox(-4.25F, -4.0F, -1.5F, 2.5F, 2.0F, 2.75F, new CubeDeformation(0.0F)).texOffs(70, 78)
