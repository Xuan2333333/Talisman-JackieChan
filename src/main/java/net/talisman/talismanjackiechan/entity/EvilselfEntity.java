...
public class EvilselfEntity extends Monster {
	...
	public EvilselfEntity(EntityType<EvilselfEntity> type, Level world) {
		...
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(TalismanJackiechanModItems.TIGER_TALISMAN_YIN.get()));
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(TalismanJackiechanModItems.TIGER_TALISMAN_YIN.get()));
	}
